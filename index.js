...
// nestedFunction can access the variable internal because they are both inside of the myFunction function.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    let populationArr = arr.map((item) => item.population);

    const reducedArr = populationArr.reduce((previousValue, currentValue) => previousValue + currentValue)
    return reducedArr
}
